                    ...
                    for (var i = 0; i < len; i += 1) {
                        ...
                        while (index < timeDifferenceEnd - eps) {
                            ...
                            if (eventSet) {
                                ...
                                eventSet = [];
                                eventSet.push(event);
                                if(event.prefer == true){
                                    rows[rowIndex][dayIndex].prefer = false;
                                    rows[rowIndex][dayIndex].validSelection = null;
                                }else{
                                    rows[rowIndex][dayIndex].prefer = true
                                    rows[rowIndex][dayIndex].validSelection = null;
                                }
...
angular.module("template/rcalendar/month.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/month.html",
    ...
    "                ng-class=\"{'text-center':true, 'monthview-current': dt.current&&!dt.selected&&!dt.hasEvent,'monthview-secondary-with-event': dt.secondary&&dt.hasEvent,'monthview-secondary-with-event': dt.secondary&&dt.hasEvent, 'monthview-primary-with-event':!dt.secondary&&dt.hasEvent&&!dt.selected,'preferedEnabled':!dt.secondary&&dt.hasEvent&&!dt.prefer, 'validDateSelected': SelectionValidation,'monthview-current_date': dt.current,'monthview-selected': dt.validSelection}\">\n" +
